...
if Anchor_num < 4 || Anchor_num > 20
    error('Anchor_num 必须在 4 到 20 之间！');
end
...
%% 2. 20点最优不共面三维立体基站拓扑池
all_anchors_pool = [
     0,  0, 0;      % 1  (4基站基础：四角错层交叉)
    20,  0, 7.5;    % 2  
    20, 40, 0;      % 3  
     0, 40, 7.5;    % 4  
     0, 40, 0;      % 5  (5-8基站：补齐立体八角包围盒)
    20,  0, 0;      % 6  
    20, 40, 7.5;    % 7  
     0,  0, 7.5;    % 8  
    10,  0, 0;      % 9  (9-12基站：强化短边中点观测)
    10,  0, 7.5;    % 10 
    10, 40, 0;      % 11 
    10, 40, 7.5;    % 12 
     0, 20, 0;      % 13 (13-16基站：强化长边中点观测)
     0, 20, 7.5;    % 14 
    20, 20, 0;      % 15 
    20, 20, 7.5;    % 16 
     0, 10, 0;      % 17 (17-20基站：强化边缘覆盖度)
    20, 10, 7.5;    % 18 
     0, 30, 7.5;    % 19 
    20, 30, 0;      % 20 
];
